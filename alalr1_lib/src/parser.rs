...
impl lalr1::Parser<AATerminal, AANonTerminal, AttributeData> for Specification {
    ...
    fn look_ahead_set(state: u32) -> OrderedSet<AATerminal> {
        ...
        match state {
            ...
            47 => ordered_set![Dot, Error, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            ...
            69 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            70 => ordered_set![Dot, VerticalBar],
            71 => ordered_set![Dot, Precedence, VerticalBar, ActionCode],
            72 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            73 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            74 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            75 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            76 => ordered_set![Dot, Error, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            ...
            87 => ordered_set![Dot, Error, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
            ...
            93 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal, PredicateExpr],
    ...
    fn next_action(
        ...
        match aa_state {
            ...
            72 => match aa_tag {
                ...
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal | PredicateExpr => Action::Reduce(62),
                _ => Action::SyntaxError,
            },
            73 => match aa_tag {
                // Symbol: Ident #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal | PredicateExpr => Action::Reduce(64),
                _ => Action::SyntaxError,
            },
            74 => match aa_tag {
                // Symbol: Literal #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal | PredicateExpr => Action::Reduce(65),
                _ => Action::SyntaxError,
            },
            75 => match aa_tag {
                // Symbol: "%error" #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal | PredicateExpr => Action::Reduce(66),
                _ => Action::SyntaxError,
            },
            76 => match aa_tag {
                // ProductionGroupHead: Ident ":" #(NonAssoc, 0)
                Dot | Error | VerticalBar | ActionCode | Ident | Literal | PredicateExpr => Action::Reduce(43),
                _ => Action::SyntaxError,
            },
            77 => match aa_tag {
            ...
            93 => match aa_tag {
                ...
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal | PredicateExpr => Action::Reduce(63),
                _ => Action::SyntaxError,
            },
            94 => match aa_tag {
            ...
            98 => match aa_tag {
                ...
                Inject | Left | NewSection | NonAssoc | Right | Ident | Literal => Action::Reduce(39),
                _ => Action::SyntaxError,
            },
            99 => match aa_tag {
                Ident => Action::Shift(98),
            ...
            match File::open(file_path) {
                Ok(mut file) => {
                    ...
                    if let Err(err) = file.read_to_string(&mut text) {
                        ...
                        self.error(location, &format!("Injected file \"{file_path}\" is empty."));
                    } else {
