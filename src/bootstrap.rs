...
impl lalr1plus::Parser<AATerminal, AANonTerminal, AAAttributeData> for ParserSpecification {
    ...
    fn next_coda(
        ...
        //         INJECT => lalr1plus::Action::Shift(4),
        //         TOKEN | FIELD
        //             => lalr1plus::Action::Reduce(6), // preamble: <empty>
        //         DCODE
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT, DCODE),
        //         }
        //     ,
        //     1 => match tag {

        //         ddEND => lalr1plus::Action::Shift(4),
        //             //return dd_accept!(),
        //         _
        //             => aa_syntax_error!(token; ddEND),
        //         }
        //     ,
        //     2 => match tag {

        //         TOKEN | FIELD | INJECT
        //             => lalr1plus::Action::Reduce(12), // field_definitions: <empty>
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT),
        //         }
        //     ,
        //     3 => match tag {

        //         ddEND | TOKEN | FIELD | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION | IDENT | DCODE
        //             => lalr1plus::Action::Reduce(3), // oinjection: injection
        //         _
        //             => aa_syntax_error!(token; ddEND, TOKEN, FIELD, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION, IDENT, DCODE),
        //         }
        //     ,
        //     4 => match tag {
        ...
        //         NEWSECTION => lalr1plus::Action::Shift(12),
        //         _
        //             => aa_syntax_error!(token; NEWSECTION),
        //         }
        //     ,
        //     8 => match tag {
        ...
        //         DOT
        //             => lalr1plus::Action::Reduce(4), // injection_head: "%inject" LITERAL
        //         _
        //             => aa_syntax_error!(token; DOT),
        //         }
        //     ,
        ...
        //         ddEND | TOKEN | FIELD | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION | IDENT | DCODE
        //             => lalr1plus::Action::Reduce(5), // injection: injection_head "."
        //         _
        //             => aa_syntax_error!(token; ddEND, TOKEN, FIELD, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION, IDENT, DCODE),
        //         }
        //     ,
        ...
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         _
        //             => aa_syntax_error!(token; INJECT, IDENT),
        //         }
        //     ,
        //     13 => match tag {
        ...
        //         TOKEN
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         LEFT | RIGHT | NONASSOC | SKIP | NEWSECTION
        //             => lalr1plus::Action::Reduce(30), // skip_definitions: <empty>
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         FIELD => lalr1plus::Action::Shift(21),
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD),
        //         }
        //     ,
        //     15 => match tag {
        ...
        //         DCODE => lalr1plus::Action::Shift(24),
        //         TOKEN | FIELD | INJECT
        //             => lalr1plus::Action::Reduce(7), // preamble: oinjection DCODE oinjection
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT, DCODE),
        //         }
        //     ,
        ...
        //         IDENT => lalr1plus::Action::Shift(29),
        //         ddEND
        //             => lalr1plus::Action::Reduce(9), // coda: <empty>
        //         DCODE
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         _
        //             => aa_syntax_error!(token; ddEND, INJECT, IDENT, DCODE),
        //         }
        //     ,
        //     17 => match tag {
        ...
        //         IDENT => lalr1plus::Action::Shift(29),
        //         _
        //             => aa_syntax_error!(token; IDENT),
        //         }
        //     ,
        //     18 => match tag {

        //         INJECT => lalr1plus::Action::Shift(4),
        //         LEFT | RIGHT | NONASSOC | NEWSECTION
        //             => lalr1plus::Action::Reduce(33), // precedence_definitions: <empty>
        //         SKIP
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         _
        //             => aa_syntax_error!(token; LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        //     19 => match tag {
        ...
        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(22), // token_definitions: oinjection token_definition
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         FIELDNAME => lalr1plus::Action::Shift(38),
        //         _
        //             => aa_syntax_error!(token; IDENT, FIELDNAME),
        //         }
        //     ,
        //     24 => match tag {
        ...
        //         ddEND
        //             => lalr1plus::Action::Reduce(1), // specification: preamble definitions "%%" production_rules coda
        //         _
        //             => aa_syntax_error!(token; ddEND),
        //         }
        //     ,
        ...
        //         ACTION => lalr1plus::Action::Shift(48),
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(52), // production_tail: <empty>
        //         _
        //             => aa_syntax_error!(token; LITERAL, ERROR, VBAR, DOT, IDENT, PREDICATE, ACTION),
        //         }
        //     ,
        //     29 => match tag {
        ...
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         NEWSECTION
        //             => lalr1plus::Action::Reduce(11), // definitions: field_definitions token_definitions skip_definitions precedence_definitions
        //         _
        //             => aa_syntax_error!(token; LEFT, RIGHT, NONASSOC, INJECT, NEWSECTION),
        //         }
        //     ,
        //     32 => match tag {
        ...
        //         SKIP => lalr1plus::Action::Shift(58),
        //         _
        //             => aa_syntax_error!(token; SKIP),
        //         }
        //     ,
        //     33 => match tag {

        //         INJECT => lalr1plus::Action::Shift(4),
        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | NEWSECTION
        //             => lalr1plus::Action::Reduce(2), // oinjection: <empty>
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        ...
        //         TOKEN | FIELD | INJECT
        //             => lalr1plus::Action::Reduce(13), // field_definitions: field_definitions oinjection field_definition oinjection
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT),
        //         }
        //     ,
        ...
        //         IDENT => {
        //             if !Self::is_allowable_name(aa_attributes.attribute_n_from_end(2 - 1).matched_text()) {
        //                 lalr1plus::Action::Reduce(16) // field_type: IDENT ?(  !is_allowable_name($1.matched_text())  ?)
        //             } else {
        //                 lalr1plus::Action::Reduce(17) // field_type: IDENT
        //             }}
        ...
        //         LITERAL => lalr1plus::Action::Shift(64),
        //         _
        //             => aa_syntax_error!(token; REGEX | LITERAL),
        //         }
        //     ,
        //     38 => match tag {
        ...
        //         TOKEN | FIELD | INJECT
        //             => lalr1plus::Action::Reduce(8), // preamble: oinjection DCODE oinjection DCODE oinjection
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT),
        //         }
        //     ,
        ...
        //         ddEND
        //             => lalr1plus::Action::Reduce(10), // coda: oinjection DCODE
        //         _
        //             => aa_syntax_error!(token; ddEND),
        //         }
        //     ,
        ...
        //         ddEND | INJECT | IDENT | DCODE
        //             => lalr1plus::Action::Reduce(45), // production_rules: production_rules production_group oinjection
        //         _
        //             => aa_syntax_error!(token; ddEND, INJECT, IDENT, DCODE),
        //         }
        //     ,
        ...
        //         DOT => lalr1plus::Action::Shift(66),
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        //     44 => match tag {

        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(50), // production_tail_list: production_tail
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(53), // production_tail: action
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         ACTION => lalr1plus::Action::Shift(48),
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(55), // production_tail: predicate
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT, ACTION),
        //         }
        //     ,
        //     47 => match tag {
        ...
        //         ACTION => lalr1plus::Action::Shift(48),
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(63), // production_tail: symbol_list
        //         _
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(64), // action: ACTION
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         PRECEDENCE | VBAR | DOT | ACTION
        //             => lalr1plus::Action::Reduce(65), // predicate: PREDICATE
        //         _
        //             => aa_syntax_error!(token; PRECEDENCE, VBAR, DOT, ACTION),
        //         }
        //     ,
        //     50 => match tag {

        //         LITERAL | PRECEDENCE | ERROR | VBAR | DOT | IDENT | PREDICATE | ACTION
        //             => lalr1plus::Action::Reduce(68), // symbol_list: symbol
        //         _
        //             => aa_syntax_error!(token; LITERAL, PRECEDENCE, ERROR, VBAR, DOT, IDENT, PREDICATE, ACTION),
        //         }
        //     ,
        ...
        //         LITERAL | PRECEDENCE | ERROR | VBAR | DOT | IDENT | PREDICATE | ACTION
        //             => lalr1plus::Action::Reduce(70), // symbol: IDENT
        //         _
        //             => aa_syntax_error!(token; LITERAL, PRECEDENCE, ERROR, VBAR, DOT, IDENT, PREDICATE, ACTION),
        //         }
        //     ,
        ...
        //         LITERAL | PRECEDENCE | ERROR | VBAR | DOT | IDENT | PREDICATE | ACTION
        //             => lalr1plus::Action::Reduce(71), // symbol: LITERAL
        //         _
        //             => aa_syntax_error!(token; LITERAL, PRECEDENCE, ERROR, VBAR, DOT, IDENT, PREDICATE, ACTION),
        //         }
        //     ,
        ...
        //         LITERAL | PRECEDENCE | ERROR | VBAR | DOT | IDENT | PREDICATE | ACTION
        //             => lalr1plus::Action::Reduce(72), // symbol: "%error"
        //         _
        //             => aa_syntax_error!(token; LITERAL, PRECEDENCE, ERROR, VBAR, DOT, IDENT, PREDICATE, ACTION),
        //         }
        //     ,
        ...
        //         LITERAL | ERROR | VBAR | DOT | IDENT | PREDICATE | ACTION =>
        //             if self.symbol_table.is_known_token(aa_attributes.attribute_n_from_end(3 - 1).matched_text()) {
        //                 lalr1plus::Action::Reduce(47) // production_group_head: IDENT ":" ?(  self.symbol_table.is_known_token($1.matched_text())  ?)
        //             } else if self.symbol_table.is_known_tag(aa_attributes.attribute_n_from_end(3 - 1).matched_text()) {
        //                 lalr1plus::Action::Reduce(48) // production_group_head: IDENT ":" ?(  self.symbol_table.is_known_tag($1.matched_text())  ?)
        //             } else {
        //                 lalr1plus::Action::Reduce(49) // production_group_head: IDENT ":"
        //             }
        ...
        //         ddEND | INJECT | IDENT | DCODE
        //             => lalr1plus::Action::Reduce(44), // production_rules: oinjection production_group oinjection
        //         _
        //             => aa_syntax_error!(token; ddEND, INJECT, IDENT, DCODE),
        //         }
        //     ,
        ...
        //         NONASSOC => lalr1plus::Action::Shift(77),
        //         _
        //             => aa_syntax_error!(token; LEFT, RIGHT, NONASSOC),
        //         }
        //     ,
        //     57 => match tag {
        ...
        //         REGEX => lalr1plus::Action::Shift(79),
        //         _
        //             => aa_syntax_error!(token; REGEX),
        //         }
        //     ,
        //     59 => match tag {

        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(23), // token_definitions: token_definitions oinjection token_definition oinjection
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         IDENT => lalr1plus::Action::Shift(81),
        //         TOKEN | FIELD | INJECT
        //             => lalr1plus::Action::Reduce(14), // field_definition: "%field" field_type field_name
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT, IDENT),
        //         }
        //     ,
        //     61 => match tag {
        ...
        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(24), // token_definition: "%token" new_token_name pattern
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(28), // pattern: REGEX
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(29), // pattern: LITERAL
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         ddEND | INJECT | IDENT | DCODE
        //             => lalr1plus::Action::Reduce(46), // production_group: production_group_head production_tail_list "."
        //         _
        //             => aa_syntax_error!(token; ddEND, INJECT, IDENT, DCODE),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(54), // production_tail: predicate action
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         ACTION => lalr1plus::Action::Shift(48),
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(59), // production_tail: symbol_list predicate
        //         _
        //             => aa_syntax_error!(token; PRECEDENCE, VBAR, DOT, ACTION),
        //         }
        //     ,
        ...
        //         ACTION => lalr1plus::Action::Shift(48),
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(61), // production_tail: symbol_list tagged_precedence
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT, ACTION),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(62), // production_tail: symbol_list action
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         IDENT => lalr1plus::Action::Shift(87),
        //         _
        //             => aa_syntax_error!(token; LITERAL, IDENT),
        //         }
        //     ,
        //     73 => match tag {

        //         LITERAL | PRECEDENCE | ERROR | VBAR | DOT | IDENT | PREDICATE | ACTION
        //             => lalr1plus::Action::Reduce(69), // symbol_list: symbol_list symbol
        //         _
        //             => aa_syntax_error!(token; LITERAL, PRECEDENCE, ERROR, VBAR, DOT, IDENT, PREDICATE, ACTION),
        //         }
        //     ,
        ...
        //         LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(31), // skip_definitions: skip_definitions oinjection skip_definition oinjection
        //         _
        //             => aa_syntax_error!(token; LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(32), // skip_definition: "%skip" REGEX
        //         _
        //             => aa_syntax_error!(token; LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         TOKEN | FIELD | INJECT
        //             => lalr1plus::Action::Reduce(15), // field_definition: "%field" field_type field_name field_conversion_function
        //         _
        //             => aa_syntax_error!(token; TOKEN, FIELD, INJECT),
        //         }
        //     ,
        ...
        //         TOKEN | LEFT | RIGHT | NONASSOC | SKIP | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(25), // token_definition: "%token" FIELDNAME new_token_name pattern
        //         _
        //             => aa_syntax_error!(token; TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(51), // production_tail_list: production_tail_list "|" production_tail
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         ACTION => lalr1plus::Action::Shift(48),
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(57), // production_tail: symbol_list predicate tagged_precedence
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT, ACTION),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(58), // production_tail: symbol_list predicate action
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //             => lalr1plus::Action::Reduce(60), // production_tail: symbol_list tagged_precedence action
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
        ...
        //         VBAR | DOT | ACTION
        //             => lalr1plus::Action::Reduce(66), // tagged_precedence: "%prec" IDENT
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT, ACTION),
        //         }
        //     ,
        ...
        //         VBAR | DOT | ACTION
        //             => lalr1plus::Action::Reduce(67), // tagged_precedence: "%prec" LITERAL
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT, ACTION),
        //         }
        //     ,
        ...
        //         LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(34), // precedence_definitions: precedence_definitions oinjection precedence_definition oinjection
        //         _
        //             => aa_syntax_error!(token; LEFT, RIGHT, NONASSOC, INJECT, NEWSECTION),
        //         }
        //     ,
        ...
        //         IDENT => lalr1plus::Action::Shift(93),
        //         LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION
        //             => lalr1plus::Action::Reduce(35), // precedence_definition: "%left" tag_list
        //         _
        ...
        //         LITERAL | LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION | IDENT
        //             => lalr1plus::Action::Reduce(38), // tag_list: tag
        //         _
        //             => aa_syntax_error!(token; LITERAL, LEFT, RIGHT, NONASSOC, INJECT, NEWSECTION, IDENT),
        //         }
        //     ,
        ...
        //         LITERAL | LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION | IDENT
        //             => lalr1plus::Action::Reduce(40), // tag: LITERAL
        //         _
        //             => aa_syntax_error!(token; LITERAL, LEFT, RIGHT, NONASSOC, INJECT, NEWSECTION, IDENT),
        //         }
        //     ,
        ...
        //         LITERAL | LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION | IDENT =>
        //             if self.symbol_table.is_known_token(aa_attributes.attribute_n_from_end(2 - 1).matched_text()) {
        //                 lalr1plus::Action::Reduce(41) // tag: IDENT ?(  self.symbol_table.is_known_token($1.matched_text())  ?)
        //             } else if self.symbol_table.is_known_non_terminal(aa_attributes.attribute_n_from_end(2 - 1).matched_text()) {
        //                 lalr1plus::Action::Reduce(42) // tag: IDENT ?(  self.symbol_table.is_known_non_terminal($1.matched_text())  ?)
        //             } else {
        //                 lalr1plus::Action::Reduce(43) // tag: IDENT
        //             }
        ...
        //         IDENT => lalr1plus::Action::Shift(93),
        //         LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION
        //              => lalr1plus::Action::Reduce(36), // precedence_definition: "%right" tag_list
        //         _
        //             => aa_syntax_error!(token; LITERAL, LEFT, RIGHT, NONASSOC, INJECT, NEWSECTION, IDENT),
        //         }
        //     ,
        ...
        //         IDENT => lalr1plus::Action::Shift(93),
        //         LEFT | RIGHT | NONASSOC | INJECT | NEWSECTION
        //              => lalr1plus::Action::Reduce(37), // precedence_definition: "%nonassoc" tag_list
        //         _
        //             => aa_syntax_error!(token; LITERAL, LEFT, RIGHT, NONASSOC, INJECT, NEWSECTION, IDENT),
        //         }
        //     ,
        ...
        //         VBAR | DOT
        //              => lalr1plus::Action::Reduce(56), // production_tail: symbol_list predicate tagged_precedence action
        //         _
        //             => aa_syntax_error!(token; VBAR, DOT),
        //         }
        //     ,
