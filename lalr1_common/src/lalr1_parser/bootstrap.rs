...
use crate::{
    OrderedSet, attributes::*, grammar::Specification, production::ProductionTail,
    symbol::Associativity, symbol::tag::TagOrToken,
};
...
impl crate::parser::Parser<AATerminal, AANonTerminal, AttributeData> for Specification {
    ...
    fn next_action(
        &self,
        aa_parse_stack: &crate::parser::ParseStack<AATerminal, AANonTerminal, AttributeData>,
