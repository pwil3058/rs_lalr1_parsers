...
impl lalr1::Parser<AATerminal, AANonTerminal, AttributeData> for Specification {
    ...
    fn look_ahead_set(state: u32) -> OrderedSet<AATerminal> {
        ...
        match state {
            ...
            3 => ordered_set![Attr, Inject, Left, NewSection, NonAssoc, ReduceReduce, Right, ShiftReduce, Skip, Target, Token, Ident, RustCode, AAEnd],
            ...
            12 => ordered_set![Dot],
            13 => ordered_set![Attr, Inject, Left, NewSection, NonAssoc, ReduceReduce, Right, ShiftReduce, Skip, Target, Token, Ident, RustCode, AAEnd],
            ...
            47 => ordered_set![Dot, Error, VerticalBar, ActionCode, Ident, Literal],
            ...
            68 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal],
            69 => ordered_set![Dot, VerticalBar],
            70 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal],
            71 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal],
            72 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal],
            73 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal],
            74 => ordered_set![Dot, Error, VerticalBar, ActionCode, Ident, Literal],
            75 => ordered_set![Ident, AAEnd],
            76 => ordered_set![Inject, Left, NewSection, NonAssoc, Right],
            77 => ordered_set![Ident, Literal],
            78 => ordered_set![Ident, Literal],
            79 => ordered_set![Ident, Literal],
            80 => ordered_set![Inject, Left, NewSection, NonAssoc, Right, Skip],
            81 => ordered_set![Inject, Left, NewSection, NonAssoc, Right, Skip],
            82 => ordered_set![Inject, NewSection],
            83 => ordered_set![Inject, NewSection],
            84 => ordered_set![Inject, Ident, AAEnd],
            85 => ordered_set![Dot, Error, VerticalBar, ActionCode, Ident, Literal],
            86 => ordered_set![Dot, VerticalBar, ActionCode],
            87 => ordered_set![Dot, VerticalBar],
            88 => ordered_set![Ident, Literal],
            89 => ordered_set![Dot, Error, Precedence, VerticalBar, ActionCode, Ident, Literal],
            90 => ordered_set![Inject, Left, NewSection, NonAssoc, Right],
            91 => ordered_set![Inject, Left, NewSection, NonAssoc, Right, Ident, Literal],
            92 => ordered_set![Inject, Left, NewSection, NonAssoc, Right, Ident, Literal],
            93 => ordered_set![Inject, Left, NewSection, NonAssoc, Right, Ident, Literal],
            94 => ordered_set![Inject, Left, NewSection, NonAssoc, Right, Ident, Literal],
            ...
            97 => ordered_set![Dot, VerticalBar],
            98 => ordered_set![Dot, VerticalBar],
            99 => ordered_set![Dot, VerticalBar, ActionCode],
    ...
    fn next_action(
        ...
        match aa_state {
            ...
            3 => match aa_tag {
                ...
                Attr | Inject | Left | NewSection | NonAssoc | ReduceReduce | Right | ShiftReduce | Skip | Target | Token | Ident | RustCode | AAEnd => Action::Reduce(3),
                _ => Action::SyntaxError,
            },
            4 => match aa_tag {
            ...
            13 => match aa_tag {
                ...
                Attr | Inject | Left | NewSection | NonAssoc | ReduceReduce | Right | ShiftReduce | Skip | Target | Token | Ident | RustCode | AAEnd => Action::Reduce(5),
                _ => Action::SyntaxError,
            },
            14 => match aa_tag {
                Inject => Action::Shift(4),
            ...
            22 => match aa_tag {
                ...
                Left | NewSection | NonAssoc | Right | Skip => Action::Reduce(27),
                _ => Action::SyntaxError,
            },
            23 => match aa_tag {
            ...
            27 => match aa_tag {
                ...
                Left | NewSection | NonAssoc | Right => Action::Reduce(30),
                _ => Action::SyntaxError,
            },
            28 => match aa_tag {
                Token => Action::Shift(30),
            ...
            39 => match aa_tag {
                ...
                Literal | RegEx => Action::Reduce(26),
                _ => Action::SyntaxError,
            },
            40 => match aa_tag {
                Inject => Action::Shift(4),
            ...
            47 => match aa_tag {
                Error => Action::Shift(73),
                ActionCode => Action::Shift(69),
                Ident => Action::Shift(71),
                Literal => Action::Shift(72),
                // ProductionTail: <empty> #(NonAssoc, 0)
                Dot | VerticalBar => Action::Reduce(45),
                _ => Action::SyntaxError,
            },
            48 => match aa_tag {
                Colon => Action::Shift(74),
                _ => Action::SyntaxError,
            },
            49 => match aa_tag {
                Inject => Action::Shift(4),
            ...
            50 => match aa_tag {
                Left => Action::Shift(77),
                NonAssoc => Action::Shift(79),
                Right => Action::Shift(78),
                _ => Action::SyntaxError,
            },
            51 => match aa_tag {
                Inject => Action::Shift(4),
            ...
            65 => match aa_tag {
                Dot => Action::Shift(84),
                VerticalBar => Action::Shift(85),
                _ => Action::SyntaxError,
            },
            66 => match aa_tag {
                // ProductionTailList: ProductionTail #(NonAssoc, 0)
                Dot | VerticalBar => Action::Reduce(43),
                _ => Action::SyntaxError,
            },
            67 => match aa_tag {
            ...
            70 => match aa_tag {
                ...
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal => Action::Reduce(54),
                _ => Action::SyntaxError,
            },
            71 => match aa_tag {
                // Symbol: Ident #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal => Action::Reduce(56),
                _ => Action::SyntaxError,
            },
            72 => match aa_tag {
                // Symbol: Literal #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal => Action::Reduce(57),
                _ => Action::SyntaxError,
            },
            73 => match aa_tag {
                // Symbol: "%error" #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal => Action::Reduce(58),
                _ => Action::SyntaxError,
            },
            74 => match aa_tag {
                // ProductionGroupHead: Ident ":" #(NonAssoc, 0)
                Dot | Error | VerticalBar | ActionCode | Ident | Literal => Action::Reduce(42),
                _ => Action::SyntaxError,
            },
            75 => match aa_tag {
                // ProductionRules: OptionalInjection ProductionGroup OptionalInjection #(NonAssoc, 0)
                Ident | AAEnd => Action::Reduce(39),
                _ => Action::SyntaxError,
            },
            76 => match aa_tag {
                Inject => Action::Shift(4),
            ...
            77 => match aa_tag {
                Ident => Action::Shift(94),
                Literal => Action::Shift(93),
                _ => Action::SyntaxError,
            },
            78 => match aa_tag {
                Ident => Action::Shift(94),
            ...
            80 => match aa_tag {
                ...
                Inject | Left | NewSection | NonAssoc | Right | Skip => Action::Reduce(28),
                _ => Action::SyntaxError,
            },
            81 => match aa_tag {
            ...
            84 => match aa_tag {
                ...
                Inject | Ident | AAEnd => Action::Reduce(41),
                _ => Action::SyntaxError,
            },
            85 => match aa_tag {
                Error => Action::Shift(73),
            ...
            88 => match aa_tag {
                Ident => Action::Shift(99),
                Literal => Action::Shift(100),
                _ => Action::SyntaxError,
            },
            89 => match aa_tag {
                // SymbolList: SymbolList Symbol #(NonAssoc, 0)
                Dot | Error | Precedence | VerticalBar | ActionCode | Ident | Literal => Action::Reduce(55),
                _ => Action::SyntaxError,
            },
            90 => match aa_tag {
                // PrecedenceDefinitions: PrecedenceDefinitions OptionalInjection PrecedenceDefinition OptionalInjection #(NonAssoc, 0)
                Inject | Left | NewSection | NonAssoc | Right => Action::Reduce(31),
                _ => Action::SyntaxError,
            },
            91 => match aa_tag {
                Ident => Action::Shift(94),
            ...
            92 => match aa_tag {
                ...
                Inject | Left | NewSection | NonAssoc | Right | Ident | Literal => Action::Reduce(35),
                _ => Action::SyntaxError,
            },
            93 => match aa_tag {
                // Tag: Literal #(NonAssoc, 0)
                Inject | Left | NewSection | NonAssoc | Right | Ident | Literal => Action::Reduce(37),
                _ => Action::SyntaxError,
            },
            94 => match aa_tag {
                // Tag: Ident #(NonAssoc, 0)
                Inject | Left | NewSection | NonAssoc | Right | Ident | Literal => Action::Reduce(38),
                _ => Action::SyntaxError,
            },
            95 => match aa_tag {
                Ident => Action::Shift(94),
            ...
            99 => match aa_tag {
                ...
                Dot | VerticalBar | ActionCode => Action::Reduce(52),
                _ => Action::SyntaxError,
            },
            100 => match aa_tag {
                // TaggedPrecedence: "%prec" Literal #(NonAssoc, 0)
                Dot | VerticalBar | ActionCode => Action::Reduce(53),
                _ => Action::SyntaxError,
            },
            101 => match aa_tag {
                // TagList: TagList Tag #(NonAssoc, 0)
                Inject | Left | NewSection | NonAssoc | Right | Ident | Literal => Action::Reduce(36),
                _ => Action::SyntaxError,
            },
    ...
    fn production_data(production_id: u32) -> (AANonTerminal, usize) {
        match production_id {
            ...
            27 => (AANonTerminal::SkipDefinitions, 0),
            28 => (AANonTerminal::SkipDefinitions, 4),
            29 => (AANonTerminal::SkipDefinition, 2),
            30 => (AANonTerminal::PrecedenceDefinitions, 0),
            31 => (AANonTerminal::PrecedenceDefinitions, 4),
            32 => (AANonTerminal::PrecedenceDefinition, 2),
            33 => (AANonTerminal::PrecedenceDefinition, 2),
            34 => (AANonTerminal::PrecedenceDefinition, 2),
            35 => (AANonTerminal::TagList, 1),
            36 => (AANonTerminal::TagList, 2),
            37 => (AANonTerminal::Tag, 1),
            38 => (AANonTerminal::Tag, 1),
            39 => (AANonTerminal::ProductionRules, 3),
            40 => (AANonTerminal::ProductionRules, 3),
            41 => (AANonTerminal::ProductionGroup, 3),
            42 => (AANonTerminal::ProductionGroupHead, 2),
            43 => (AANonTerminal::ProductionTailList, 1),
            44 => (AANonTerminal::ProductionTailList, 3),
            45 => (AANonTerminal::ProductionTail, 0),
            46 => (AANonTerminal::ProductionTail, 1),
            47 => (AANonTerminal::ProductionTail, 3),
            48 => (AANonTerminal::ProductionTail, 2),
            49 => (AANonTerminal::ProductionTail, 2),
            50 => (AANonTerminal::ProductionTail, 1),
            51 => (AANonTerminal::Action, 1),
    ...
    fn goto_state(lhs: &AANonTerminal, current_state: u32) -> u32 {
        match current_state {
            ...
            52 => match lhs {
                AANonTerminal::RegularExpression => 81,
                _ => panic!("Malformed goto table: ({lhs}, {current_state})"),
            },
            58 => match lhs {
    ...
    fn do_semantic_action<F: FnMut(String, String)>(
        ...
        if !Self::is_allowable_name(name) {
            ...
            aa_lhs.production_tail_list_mut().push(production_tail.clone());
            ...
            let tail = ProductionTail::new(aa_rhs[0].symbol_list(), None, None);
            aa_lhs = AttributeData::ProductionTail(tail)
            ...
            if let Some(tag) = self.symbol_table.get_tag(name) {
                ...
                aa_lhs = AttributeData::AssociativityAndPrecedence(tag.associativity(), tag.precedence());
            } else if let Some(token) = self.symbol_table.get_token(name) {
                aa_lhs = AttributeData::AssociativityAndPrecedence(token.associativity(), token.precedence());
            } else {
