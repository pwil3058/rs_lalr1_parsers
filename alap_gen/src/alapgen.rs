...
impl lalr1_plus::Parser<AATerminal, AANonTerminal, AttributeData> for GrammarSpecification {
    ...
    fn look_ahead_set(state: u32) -> BTreeSet<AATerminal> {
        ...
        return match state {
            ...
            3 => btree_set![AAEnd, ATTR, TARGET, TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION, IDENT, RUSTCODE],
            4 => btree_set![LITERAL],
            5 => btree_set![DOT],
            ...
            11 => btree_set![IDENT],
            12 => btree_set![DOT],
            13 => btree_set![AAEnd, ATTR, TARGET, TOKEN, LEFT, RIGHT, NONASSOC, SKIP, INJECT, NEWSECTION, IDENT, RUSTCODE],
